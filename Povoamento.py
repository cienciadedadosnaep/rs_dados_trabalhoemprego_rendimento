...
df = pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_trabalhoemprego_rendimento/data/POVOAMENTO.csv', sep = ';')
...
for i in range(1,len(df)):
    ...
    code = list(pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_trabalhoemprego_rendimento/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
